...
//                    }
    ...
    @Override
    public boolean isMenuAltUpButton() { return gamepad1.left_bumper;} //isMenuUpButton
    ...
    @Override
    public boolean isMenuAltDownButton() { return gamepad1.right_bumper;} //isMenuUpButton
    ...
    private void doMenus()
    {
        ...
        parkMenu.addChoice("CENTER_PARK", Route.ParkPos.CENTER_PARK, true, delayMenu);
        parkMenu.addChoice("DEFEND_PARK", Route.ParkPos.DEFEND_PARK, false, delayMenu);
