...
import org.firstinspires.ftc.teamcode.util.DriveTestUtil;
...
//        dtu.driveDist(12.0, 0.2, true);
    ...
    private void setupLogger()
    {
        ...
        {
            Date day = new Date();
            dl = new DataLogger("driveTest_" + day.toString());
            dl.addField("NOTE");
            dl.addField("Frame");
            dl.addField("Gyro");
            dl.addField("LENC");
    ...
    @Override
    public boolean isMenuAltUpButton() { return gamepad1.left_bumper; }
    ...
    @Override
    public boolean isMenuAltDownButton() { return gamepad1.right_bumper; }
    ...
    private void doMenus()
    {
        ...
        for(String str : tests)
        {
            testMenu.addChoice(str, str, false);
        }
